...
fun getVenueData(venueSlug: String?): VenueResponse {
    ...
    try {
        val venueStaticApiResponse: String? = restTemplate.getForObject<String>("$apiUrl/static", String::class.java);
        val venueDynamicApiResponse: String? = restTemplate.getForObject<String>("$apiUrl/dynamic", String::class.java);
